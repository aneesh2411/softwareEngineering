...
$reason = $_POST['reason'];
$adv = $_POST['adv'];
mysqli_query($db,"INSERT INTO `ordinary`(`id`, `fname`, `lname`, `sdate`, `edate`, `rollno`, `branch`, `pno`, `reason`, `advisor`) VALUES (NULL,'$fname','$lname','$sdate','$edate','$rollno','$branch','$number','$reason','$adv')") or die("Erroorrrr....");
?>
