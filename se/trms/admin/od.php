...
$file= $_POST['file'];
print("gey");
mysqli_query($db,"INSERT INTO `od`(`id`, `fname`, `lname`, `sdate`, `edate`, `rollno`, `branch`, `number`, `reason`, `advisor`, `file`) VALUES (NULL,'$fname','$lname','$sdate','$edate','$rollno','$branch','$number','$reason','$adv','$file')") or die("Erroorrrr....");
?>
...
background: 
  ...
  <body>
    <div class="testbox">
      <form method='post'>
        <div class="banner">
          <h1>On-Duty Application Form</h1>
        </div>
        <div class="item">
        ...
        <div class="item">
          <div class="name-item">
            ...
            <div>
              ...
              <input id="number" type="text" name="branch" />
            </div>
			  <div>
        ...
        <div class="item">
          <div class="name-item">
            <div>
              <label for="language"><b>Reason for OD</b><span>*</span></label>
        ...
        <div class="item">
          <label for="cv"><b>Upload OD form</b><span>*</span></label>
          <input  id="cv" type="file" name="file" required/>
        </div>
     <!--   <div class="item">
