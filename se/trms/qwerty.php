				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item"><a href="#" class="notification"><span>INBOX</span><span class="badge"></span></a></li>
							
							<a class="popup" onclick="myFunction()">Click here
  <span class="popuptext" id="myPopup">A simple</span> 
</a>
