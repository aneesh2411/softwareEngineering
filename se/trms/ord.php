...
mysqli_query($db,"INSERT INTO `ordinary`(`id`, `firstname`, `lastname`, `startdate`, `enddate`, `rollno`, `branch`, `pno`, `reason`, `advisor`) VALUES (NULL,'$fname','$lname','$sdate','$edate','$rollno','$branch','$number','$reason','$adv')") or die("Erroorrrr....");
?>
